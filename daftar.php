...
if (isset($_POST['daftar'])) {
    ...
    $gelombang = 1;
    $tahun_pelatihandate("Y");
                                                                                                                                
    
    $insert = mysqli_query($koneksi, "INSERT INTO
        peserta (nik, nama, email, hp, alamat, pendidikan, gender,id_jurusan, gelombang, tahun_pelatihan)
        VALUES('$nik','$nama','$email','$hp','$alamat','$pendidikan','$gender','$id_jurusan','$gelombang','$tahun_pelatihan')");
    if ($insert) {
        // redirect
